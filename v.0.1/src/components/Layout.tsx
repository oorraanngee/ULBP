        ...
        <div className="max-w-[1200px] mx-auto flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 mt-1">
              <div className="flex bg-white text-[#333] px-3 py-1.5 rounded gap-1 items-center cursor-pointer hover:bg-gray-100 transition-colors text-xs font-bold shadow-sm">
