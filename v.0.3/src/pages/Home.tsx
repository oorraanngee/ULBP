      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8 font-black">
        ...
        <div className="bg-gradient-to-b from-[#0fd8f5] to-[#0a9eb5] rounded-[2rem] p-6 shadow-xl border-4 border-white/40">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://discord.gg/zk3vW4uQ" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gradient-to-b from-[#87d52f] to-[#4fa315] hover:from-[#9af236] hover:to-[#5ebf1a] text-white text-center rounded-xl shadow-[0_4px_0_#2b6307] active:shadow-[0_0px_0_#2b6307] active:translate-y-[4px] transition-all uppercase tracking-wider text-sm drop-shadow-md border border-white/30">
              {t.discord}
            </a>
            <a href="https://bsky.app/profile/ulbp.bsky.social" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gradient-to-b from-[#87d52f] to-[#4fa315] hover:from-[#9af236] hover:to-[#5ebf1a] text-white text-center rounded-xl shadow-[0_4px_0_#2b6307] active:shadow-[0_0px_0_#2b6307] active:translate-y-[4px] transition-all uppercase tracking-wider text-sm drop-shadow-md border border-white/30">
              {t.bluesky}
            </a>
            <a href="https://www.youtube.com/@UltimateLittleBigPlanet" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gradient-to-b from-[#87d52f] to-[#4fa315] hover:from-[#9af236] hover:to-[#5ebf1a] text-white text-center rounded-xl shadow-[0_4px_0_#2b6307] active:shadow-[0_0px_0_#2b6307] active:translate-y-[4px] transition-all uppercase tracking-wider text-sm drop-shadow-md border border-white/30">
              {t.youtube}
            </a>
            <button onClick={() => { localStorage.removeItem('ulbp_lang'); window.location.href='/'; }} className="w-full py-3 bg-gradient-to-b from-[#87d52f] to-[#4fa315] hover:from-[#9af236] hover:to-[#5ebf1a] text-white text-center rounded-xl shadow-[0_4px_0_#2b6307] active:shadow-[0_0px_0_#2b6307] active:translate-y-[4px] transition-all uppercase tracking-wider text-sm drop-shadow-md border border-white/30">
              {t.changeLanguage}
            </button>
          </div>
        </div>
